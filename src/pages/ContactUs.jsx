        ...
        <div className='space-y-4'>
              ...
              <div className='flex items-center gap-4'>
                    <a target='_blank' href="https://www.linkedin.com/company/leadsnite/" rel="noopener noreferrer">
                      <FaLinkedinIn className='text-4xl rounded-md border-2 border-black p-2 hover:text-[#03ABE4] hover:border-[#03ABE4] transition-colors'/>
                    </a>
              </div>
        </div>
     </div>
...
{location.pathname === "/contact-us" && (
        <>
        <h2 className='text-center block lg:hidden text-black lg:text-4xl text-3xl font-bold mt-6 font-satochi'>Our Response Time</h2>
          <ResponseTimeSection />
          <ContactFaqs />
        </>
      )}
