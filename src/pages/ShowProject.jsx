    ...
    <div className='lg:px-38 px-4 md:px-20 lg:py-18 py-4'>
      ...
      <div className="bg-white  w-full flex items-center justify-center    py-12">
        ...
        <div className="max-w-7xl mx-auto lg:py-12 px-4 w-full">
          {/* Header Tabs */}
          <div className="flex lg:items-center lg:justify-end  lg:gap-6 gap-3 mb-6 flex-wrap lg:text-lg  text-sm">
            <button
              onClick={() => handleTabChange('website')}
              className={`px-4 py-2 whitespace-nowrap transition-colors  ${activeTab === 'website'
                  ? 'btn2 '
                  : 'btn'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2  whitespace-nowrap transition-colors ${activeTab === 'mobileApp'
                  ? 'btn2'
                  : 'btn'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2  whitespace-nowrap transition-colors ${activeTab === 'machineLearning'
                  ? 'btn2'
                  : 'btn  '
                }`}
            >
