...
function WebCardDetail() {
  ...
  return (
    <div className="max-w-7xl mx-auto md:px-8 lg:py-12 px-4 w-full  ">
      {/* Hero */}
     <section className="mt-12 flex flex-col lg:flex-row items-start lg:justify-between   lg:gap-22 gap-4">
       ...
       <div className="lg:w-[50%] w-full space-y-4">
         ...
         <ul className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
           {project.overview.projectTitle.map((title, i) => (
             <li style={{borderRadius: "9999px"}} className=" btn  py-3 px-3 rounded-full text-center text-nowrap font-semibold" key={i}>{title}</li>
           ))}
         </ul>
