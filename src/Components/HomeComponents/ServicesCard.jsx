...
const servicesData = [
  {
    ...
    technologies: ["/New/New/Website/1.png", "/New/New/Website/2.png", "/New/New/Website/3.png", "/New/New/Website/4.png", "/New/New/Website/5.png", "/New/New/Website/8.png",  "/New/New/Website/7.png"],
  ...
  },
  {
    ...
    technologies: ["/New/New/AI agents/ai agents (1).png", "/New/New/AI agents/ai agents (2).png", "/New/New/AI agents/ai agents (3).png", "/New/New/AI agents/ai agents (4).png", "/New/New/AI agents/ai agents (5).png", "/New/New/AI agents/ai agents (6).png", "/New/New/AI agents/ai agents (7).png",],
  ...
  },
  {
    ...
    technologies: ["/New/New/Mobile Application/1.png", "/New/New/Mobile Application/2.png", "/New/New/Mobile Application/3.png", "/New/New/Mobile Application/4.png", "/New/New/Mobile Application/5.png", "/New/New/Mobile Application/6.png", "/New/New/Mobile Application/7.png", "/New/New/Mobile Application/8.png"],
  ...
  },
  {
    ...
    technologies: ["/New/New/MVP/mvp (1).svg", "/New/New/MVP/mvp (3).svg", "/New/New/MVP/mvp (4).svg", "/New/New/MVP/mvp (5).svg", "/New/New/MVP/mvp (6).svg", "/New/New/MVP/mvp (7).svg", "/New/New/MVP/mvp (8).svg", "/New/New/MVP/mvp (9).svg",],
  ...
  return (
    ...
    >
      <div className="py-8 px-8">
        ...
        <button 
          onClick={handleClick}
          className=" text-[#01ACE4]  underline mt-3 rounded-lg hover:bg-primary/90 transition-colors duration-300"
        >
          Read More
        </button>
      </div>
